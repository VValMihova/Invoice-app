...
-- PASSWORD IS "admin"
INSERT .users (id, email, password, company_details_id, uuid) VALUES (1, 'admin@abv.bg', '$2a$10$I54tU8P7K2HPz6IWmUjw.ezRlRW6Es2uzQuBkLBvupYulCSzQViE6', 1, '91071533-ae2f-4396-8a46-a7cc3e3d86e0');
...
INSERT INTO bank_accouns_persistant (id, bic, currency, iban, user_id) VALUES (1, 'DEUTDEFF', 'USS', 'BG80BNBG96611020345128', 2);

INSERT INTO invoices (id, amount_due, invoice_number, issue_date, total_amount, vat, bank_account_persist_id, recipient_id, supplier_id, user_id) VALUES (1, 58.80, 1, '2024-07-27', 49.00, 9.80, 1, 2, 2, 2);

INSERT INTO invoice_items (id, name, quantity, total_price, unit_price, invoice_id) VALUES (1, 'product1', 2.0000, 14.00, 7.00, 1);
INSERT INTO invoice_items (id, name, quantity, total_price, unit_price, invoice_id) VALUES (2, 'product2', 5.0000, 35.00, 7.00, 1);

INSERT INTO sales (id, invoice_id, product_name, quantity, sale_date, user_id) VALUES (1, 1, 'product1', 2.00, '2024-07-27', 2);
INSERT INTO sales (id, invoice_id, product_name, quantity, sale_date, user_id) VALUES (2, 1, 'product2', 5.00, '2024-07-27', 2);
