...
function addInvoiceItem() {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <input type="number" name="items[${itemIndex}].quantity" placeholder="Quantity" class="form-control" oninput="calculateTotalPrice(this)" required/>
            <small class="text-danger"></small>
        </td>
        <td>
            <input type="number" name="items[${itemIndex}].unitPrice" placeholder="Unit Price" class="form-control" oninput="calculateTotalPrice(this)" required/>
            <small class="text-danger"></small>
        </td>
        <td>
            <input type="number" name="items[${itemIndex}].totalPrice" placeholder="Total Price" class="form-control" readonly/>
            <small class="text-danger"></small>
        </td>
        <td>
